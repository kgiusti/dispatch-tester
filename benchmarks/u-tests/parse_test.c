...
{"\xa0",             1, "Insufficient Data to Determine Length"},        // 2
{"\xb0",             1, "Insufficient Data to Determine Length"},        // 3
{"\xb0\x00",         2, "Insufficient Data to Determine Length"},        // 4
{"\xb0\x00\x00",     3, "Insufficient Data to Determine Length"},        // 5
{"\xb0\x00\x00\x00", 4, "Insufficient Data to Determine Length"},        // 6
{"\xc0\x04",         2, "Insufficient Data to Determine Length"},         // 7
{"\xd0\x00\x00\x00\x00\x00\x00\x00\x01",  9, "Insufficient Length to Determine Count"}, // 8
{0, 0, 0}
};
